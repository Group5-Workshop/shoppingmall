...
public class Sql {
    ...
    public static final String INSERT_CUSTOMER =
            "INSERT INTO customer (pwd, cname, email, phone, birth_date, nick_name, grade, join_date) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)";
    ...
    public static final String UPDATE_CUSTOMER =
            "UPDATE customer SET cname=?, email=?, phone=? WHERE cid=?";
    ...
    // 주소 관련
    public static final String INSERT_ADDRESS = "INSERT INTO address (cid, aname, address, address_detail, zip_code) VALUES (?, ?, ?, ?, ?)";
    public static final String UPDATE_ADDRESS = "UPDATE address SET aname=?, address=?, address_detail=?, zip_code=? WHERE aid=?";
    public static final String DELETE_ADDRESS = "DELETE FROM address WHERE aid=?";
    public static final String SELECT_ONE_ADDRESS = "SELECT * FROM address WHERE aid=?";
